                                                ...
                                                <div class="col-12">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <textarea type="text" name="address" class="form-control h--90px"
                                                            placeholder="{{ translate('Ex: 666/668 DOHS Mirpur, Dhaka, Bangladesh') }}" value="{{ old('address') }}" required>{{ old('address') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="password" name="password" class="form-control"
                                                                ...
                                                                maxlength="255" value="{{ old('password') }}" required>
...
@push('script_2')
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ \App\Model\BusinessSetting::where('key', 'map_api_key')->first()->value }}&libraries=places&v=3.45.8">
    </script>
