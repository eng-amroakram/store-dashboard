                        ...
                        <div class="p-2">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('Maximum_Order_Quantity') }} <span
                                                id="maximum_order_quantity"></span></label>
                                        <input type="number" min="0" value="0" max="100000" name="maximum_order_quantity" class="form-control"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('Points/One') }} <span
                                                id="points"></span></label>
                                        <input type="number" min="0" value="0" max="1000" name="points" class="form-control"
                                            placeholder="{{ translate('Ex : 10') }}" required>
                                    </div>
                                </div>
