                ...
                <table class="table table-borderless table-hover table-align-middle m-0 text-14px">
                    <thead class="thead-light">
                        <tr class="word-nobreak">
                            ...
                            <th class="text-center">{{ translate('Total Points') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        @if ($customer->wallet)
                                            <span
                                                class="badge @if (!$customer->wallet->points) badge-soft-danger @else badge-soft-info @endif   py-2 px-3 font-medium">
                                                {{ $customer->wallet->points }}
                                            </span>
                                        @else
                                            <span class="badge badge-soft-danger py-2 px-3 font-medium">
                                                {{ '0' }}
                                            </span>
                                        @endif
                                    </div>
